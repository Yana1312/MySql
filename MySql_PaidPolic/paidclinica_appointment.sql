...
CREATE TABLE `appointment` (
  ...
  PRIMARY KEY (`idPatient`,`idDoctors`),
  KEY `doc_idx` (`idDoctors`),
  CONSTRAINT `doc` FOREIGN KEY (`idDoctors`) REFERENCES `doctors` (`idDoctors`),
  CONSTRAINT `pat` FOREIGN KEY (`idPatient`) REFERENCES `patient` (`idPatient`)
